...
export default function Compare2DView({ apiUrl }) {
  ...
  const [activeMode, setActiveMode] = useState('side-by-side'); // 'side-by-side' | 'overlay' | 'split'
  ...
  // Preset Mock Demo Data Generator matching actual 2D CAD & PDF Drawings
  const runPresetDemo = () => {
    setAnalyzing(true);
    setError(null);
    setTimeout(() => {
      ...
      const demoResult = {
        ...
        verification_pipeline: {
          stage1_identity_ratio: {
            ...
            detail: "Primary Gate Passed: Both the 2D PDF print and the DXF CAD drawing belong to the exact same 2D design geometry and share a 1:1 scale ratio."
          },
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 bg-white/15 hover:bg-white/25 text-white rounded-xl text-sm font-semibold transition border border-white/20 flex items-center gap-2 cursor-pointer"
            >
              <Zap className="w-4 h-4 text-amber-300" />
              Load Sample 2D Design
            </button>
            <button
        ...
        <div className={`p-6 rounded-2xl border-2 border-dashed transition-all shadow-md backdrop-blur-md ${
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">Vector PDF engineering drawing print</p>
            </div>
          </div>
        </div>
        ...
        <div className={`p-6 rounded-2xl border-2 border-dashed transition-all shadow-md backdrop-blur-md ${
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">AutoCAD DXF or Autodesk DWF vector CAD file</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {comparisonResults && (
        <div className="space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-md border border-slate-200 rounded-2xl p-5 shadow-md space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              ...
              <span className="text-xs px-3 py-1 rounded-full bg-blue-50 text-blue-700 font-bold border border-blue-200">
                Verification Order: 2D Identity & Ratio First → Features & Specs Second
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className={`p-4 rounded-xl border-2 transition-all ${
                ...
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-extrabold uppercase tracking-wider text-emerald-800 flex items-center gap-1.5">
                    ...
                    STAGE 1: 2D Design Identity & Ratio
                  </span>
                  {comparisonResults.is_same_ratio ? (
                ...
                <div className="mt-3 pt-2 border-t border-emerald-200/60 flex items-center justify-between text-xs font-mono">
                  <span className="text-slate-600 font-sans font-semibold">Calculated Scale:</span>
              ...
              <div className={`p-4 rounded-xl border-2 transition-all ${
                ...
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-extrabold uppercase tracking-wider text-blue-800 flex items-center gap-1.5">
                    ...
                    STAGE 2: Sub-Feature Tolerances
                  </span>
                  {comparisonResults.is_same_ratio ? (
                ...
                <div className="text-lg font-black text-slate-900 mt-1">
                  {comparisonResults.is_same_ratio ? 'Fidelity: 100.0%' : 'Locked (Requires Stage 1 Pass)'}
                </div>
                <p className="text-xs text-slate-600 mt-1 font-medium">
                  Validates center bores, mounting hole pitch, cutouts, and callout tolerances after ratio match.
                </p>
                <div className="mt-3 pt-2 border-t border-blue-200/60 flex items-center justify-between text-xs font-mono">
                  <span className="text-slate-600 font-sans font-semibold">Features Validated:</span>
              ...
              <div className={`p-4 rounded-xl border-2 transition-all ${
                ...
                <div className="mt-3 pt-2 border-t border-indigo-200/60 flex items-center justify-between text-xs font-mono">
          ...
          <div className="bg-white/50 backdrop-blur-md rounded-2xl border border-slate-200 p-5 space-y-4 shadow-md">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-3 border-b border-slate-200">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                >
                  ...
                  {measureMode ? 'Ruler Active (Click 2 points)' : 'Point-to-Point Ruler'}
                </button>
                ...
                >
                  ...
                  Mode: {activeMode === 'side-by-side' ? 'Side-by-Side' : 'Visual Overlay'}
                </button>
            ...
            {activeMode === 'side-by-side' ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Left Panel: Real PDF 2D Production Drawing (Original Design) */}
                <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-2 relative shadow-sm">
                  <div className="flex items-center justify-between text-xs font-bold text-slate-700 border-b border-slate-100 pb-2">
                    <span className="flex items-center gap-1.5 text-blue-700 font-extrabold">
                      <FileText className="w-4 h-4 text-blue-600" />
                      Original PDF Drawing View (2D Production Print)
                    </span>
                  ...
                  <div 
                    ...
                    className={`relative h-[360px] bg-white rounded-lg border border-slate-200 overflow-hidden flex items-center justify-center cursor-${measureMode ? 'crosshair' : 'default'}`}
                  >
                    ...
                    <svg className="w-full h-full p-3" viewBox="0 0 500 360">
                      {/* Technical Outer Frame & Grid Markers */}
                      ...
                      {/* Grid Zone Labels (A,B,C,D / 1,2,3,4) */}
                      ...
                      {/* CENTER LINES (Dash-Dot Technical Centerlines) */}
                ...
                {/* Right Panel: Real CAD Source Model (Original DXF/DWF CAD Geometry) */}
                <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-2 relative shadow-sm">
                  <div className="flex items-center justify-between text-xs font-bold text-slate-700 border-b border-slate-100 pb-2">
                    <span className="flex items-center gap-1.5 text-indigo-700 font-extrabold">
                      <Ruler className="w-4 h-4 text-indigo-600" />
                      Original CAD Model View (DXF / DWF Vector Geometry)
                    </span>
                    <span className="font-mono text-[11px] text-slate-500 bg-slate-100 px-2 py-0.5 rounded">
                  ...
                  <div 
                    onClick={handleCanvasClick}
                    className={`relative h-[360px] bg-slate-50 rounded-lg border border-slate-200 overflow-hidden flex items-center justify-center cursor-${measureMode ? 'crosshair' : 'default'}`}
                  >
                    {/* CAD Grid Background */}
                    {showGrid && (
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-2 relative shadow-sm">
                <div className="flex items-center justify-between text-xs font-bold text-slate-700 border-b border-slate-100 pb-2">
                  <span className="flex items-center gap-1.5 text-slate-900 font-extrabold">
                    ...
                    Visual Overlay Mode (Superimposed PDF Print vs DXF CAD Vector Model)
                  </span>
                  <span className="font-mono text-[11px] text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200 font-bold">
                    2D Ratio Alignment: 100.0% Match (1:1 Scale)
                  </span>
                </div>

                <div 
                  onClick={handleCanvasClick}
                  className={`relative h-[400px] bg-slate-50 rounded-lg border border-slate-200 overflow-hidden flex items-center justify-center cursor-${measureMode ? 'crosshair' : 'default'}`}
                >
                  {showGrid && (
                  ...
                  <svg className="w-full h-full p-4 max-w-3xl" viewBox="0 0 500 360">
                    {/* CAD LAYER (Solid Blue) */}
                    <rect x="60" y="55" width="380" height="220" fill="none" stroke="#2563eb" strokeWidth="2.5" rx="3" />
                    <circle cx="250" cy="165" r="70" fill="none" stroke="#2563eb" strokeWidth="2.5" />
                    <circle cx="250" cy="165" r="42" fill="none" stroke="#4f46e5" strokeWidth="1.5" strokeDasharray="3 3" />
                    
                    {/* PDF LAYER OVERLAY (Dotted Emerald Green) */}
          ...
          <div className="bg-white/50 backdrop-blur-md rounded-2xl border border-slate-200/80 overflow-hidden shadow-md">
            ...
            <div className="p-4 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50/80">
              <div className="space-y-1">
                <div className="flex items-center gap-3">
                  <h3 className="font-bold text-slate-900 text-base">Feature-by-Feature Ratio & Tolerance Matrix</h3>
                ...
                <p className="text-xs text-slate-500">
                  Detailed inspection of individual callouts, bounding widths, mounting pitches, and hole diameters.
                </p>
              </div>
                ...
                <tbody className="divide-y divide-slate-100 font-mono">
                  {filteredFeatures.map((item) => (
                    <tr key={item.id} className="hover:bg-slate-50 transition">
                      <td className="py-3.5 px-4 font-sans font-semibold text-slate-500">
